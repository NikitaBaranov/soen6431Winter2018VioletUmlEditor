...
public class ViewMenu extends JMenu
{
    ...
    private void createMenu()
    {
            ...
            public void actionPerformed(ActionEvent event)
            {
                	...
                	for(int i=0;i<temp_arraylist.size();i++) {
                		...
                		if(itemp.getStartNode().equals(jtemp.getEndNode()) || itemp.getEndNode().equals(jtemp.getStartNode())){
                			...
                			dialogFactory.showErrorDialog("BidirectionalOccuring");
                			return;
        ...
        temporary2.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent event)
            {
                	...
                	for(int i=0;i<temp_arraylist2.size();i++) {
                		...
                		if(itemp2.getStartNode().equals(itemp2.getEndNode())){
                			...
                			dialogFactory.showErrorDialog("Class showes relation to itself");
                			return;
    ...
    @ResourceBundleBean(key = "view.temporary") //try to execute now
    private JMenuItem temporary;
    
    @ResourceBundleBean(key = "view.temporary2") //try to execute now
    private JMenuItem temporary2;
